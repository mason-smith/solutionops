...
export const projects: Array<Project> = [
  ...
  },
  {
    ...
    stack: ["React 19", "Hono", "Cloudflare Workers", "Neon Postgres", "Drizzle ORM", "TanStack Router", "Turborepo"],
    url: "https://kazetask.com",
    github: "https://github.com/solution-ops/task.cloud",
    status: "live",
    images: {
      hero: {
        dark: img("kazetask", "dashboard-desktop-dark.webp"),
        light: img("kazetask", "dashboard-desktop-light.webp"),
        alt: "Kaze Task dashboard with category view",
      },
      fan: [
        { src: img("kazetask", "dashboard-mobile-dark.webp"), alt: "Kaze Task mobile dashboard" },
        { src: img("kazetask", "task-view-mobile-dark.webp"), alt: "Task detail on mobile" },
        { src: img("kazetask", "task-view-mobile-light.webp"), alt: "Task view in light mode" },
      ],
    },
  },
  {
